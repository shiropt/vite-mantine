...
const setup = () => {
  ...
  const loginButton = screen.getByRole('button', { name: ariaLabel.login });
  const passwordForgotLink = screen.getByRole('link', { name: ariaLabel.passwordForgot });
  const signupLink = screen.getByRole('link', { name: ariaLabel.signup });
